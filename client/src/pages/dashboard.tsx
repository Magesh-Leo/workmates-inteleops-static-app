        ...
        {/* <Card>
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              <div className="flex items-center">
                <i className="fas fa-building text-workmates-primary mr-2"></i>
                Client Portfolio
              </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 border rounded-lg">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                    <span className="text-workmates-primary font-bold text-sm">TC</span>
                  </div>
                  <div>
                    <div className="font-medium">TechCorp Solutions</div>
                    <div className="text-sm text-text-secondary">Enterprise - 847 tickets/month</div>
                  </div>
                </div>
              ...
              <div className="flex justify-between items-center p-3 border rounded-lg">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center">
                    <span className="text-workmates-orange font-bold text-sm">DS</span>
                  </div>
                  <div>
                    <div className="font-medium">Digital Systems Inc</div>
                    <div className="text-sm text-text-secondary">Mid-tier - 312 tickets/month</div>
                  </div>
                </div>
                <Badge className="bg-green-100 text-green-800">Active</Badge>
              </div>
              <div className="flex justify-between items-center p-3 border rounded-lg">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center">
                    <span className="text-purple-600 font-bold text-sm">IS</span>
                  </div>
                  <div>
                    <div className="font-medium">InnovateSoft</div>
                    <div className="text-sm text-text-secondary">Startup - 89 tickets/month</div>
                  </div>
                </div>
