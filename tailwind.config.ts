  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Workmates IntelliOps theme colors
        "workmates-primary": "var(--workmates-primary)",
        "workmates-secondary": "var(--workmates-secondary)",
        "workmates-blue": "var(--workmates-blue)",
        "workmates-orange": "var(--workmates-orange)",
